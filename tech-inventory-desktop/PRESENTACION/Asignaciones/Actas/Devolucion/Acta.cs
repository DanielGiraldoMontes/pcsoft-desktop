...
namespace PRESENTACION.Asignaciones.Actas.Devolucion
{
    public partial class Acta : Form
    {
        ...
        private void Acta_Load(object sender, EventArgs e)
        {
            ...
            ReporteDevolucion.LocalReport.SetParameters(parametros);


            ReportDataSource Sourse = new ReportDataSource();
            Sourse.Name = "EQUIPOS";
            Sourse.Value = asignaciones.CargarDevolucionDetalle(asignacion.id);
            ReporteDevolucion.LocalReport.DataSources.Add(Sourse);


            ReporteDevolucion.RefreshReport();
            ReporteDevolucion.SetDisplayMode(DisplayMode.PrintLayout);
